        ...
        <div class="sidebar-widget">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="about-thumb-wrap text-center mb-30 w-80">
                        <img src="{{asset(Auth::check() ? Auth::user()->avatar : 'https://vtv1.mediacdn.vn/thumb_w/650/2014/incognito-chrome-spicytricks-1420018283508.jpg')}}" alt="about">
                    </div>
                </div>
                <div class="col-lg-6 col-md-10">
