            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div  class="card-profile-image">
                  <a href="#">
                    <img id="avatar" src="{{asset(Auth::check() ? Auth::user()->avatar : 'https://vtv1.mediacdn.vn/thumb_w/650/2014/incognito-chrome-spicytricks-1420018283508.jpg')}}" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
