...
@section('content')
    <div>
        <div class="card card-custom">
            ...
            <form action="{{route('admin.language.update', $lang->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" name="name" type="text"
                                   value="{{old('name') ? old('name') : $lang->name}}"/>
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input type="file" class="form-control" name="flag" value="{{old('flag') ? old('flag') : $lang->flag}}"/>
                            <img id="image" src="{{ asset($lang->flag) }}" width="60px" height="60px">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" name="code" type="text"
                                   value="{{old('code') ? old('code') : $lang->code}}"/>
                        </div>
                    </div>
                    <div class="form-group row">
