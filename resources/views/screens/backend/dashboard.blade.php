            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-custom bg-gray-100 gutter-b card-stretch">
                        ...
                        <div class="card-body p-0 position-relative overflow-hidden">
                            <!--begin::Chart-->
                            <div id="kt_mixed_widget_3_chart" class="card-rounded-bottom bg-dark"
                                 style="height: 200px"></div>
                            <!--end::Chart-->
                            <!--begin::Stats-->
                            <div class="card-spacer mt-n25">
...
{{--                                    <a href="#" class="text-dark font-weight-bolder text-hover-primary font-size-h5">Monthly--}}
{{--                                        Subscription--}}
{{--                                        <br/>Based SaaS</a>--}}
...
{{--                                <br/>Generator</a>--}}
{{--                            <!--begin::Desc-->--}}
{{--                            <p class="text-dark-50 font-weight-normal font-size-lg mt-6">Pitstop creates quick and easy--}}
{{--                                email campaigns.--}}
...
{{--                                                <div class="font-size-sm text-muted font-weight-bold mt-1">Author--}}
{{--                                                    Sales--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                            <!--end::Title-->--}}
...
{{--                                            <div>--}}
{{--                                                <div class="font-size-h4 text-dark-75 font-weight-bolder">$706</div>--}}
{{--                                                <div class="font-size-sm text-muted font-weight-bold mt-1">Commision--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                            <!--end::Title-->--}}
{{--                                        </div>--}}
