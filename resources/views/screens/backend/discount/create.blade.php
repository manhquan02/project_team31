...
<div class="card card-custom">
    ...
    <form action="{{route('admin.discount.postDiscount')}}" method="POST">
     ...
     <div class="card-body">
      ...
      <div class="form-group row">
       ...
       <div class="col-10">
        <input class="form-control @error('price_sale') is-invalid @enderror" name="price_sale" type="number" value="{{old('price_sale') }}" placeholder="%" id="example-tel-input"/>
        @error('price_sale')
            <span class="text-danger">{{ $message }}</span>    
        @enderror
       </div>
      ...
      <div class="form-group row">
       ...
       <div class="col-10">
        <input class="form-control @error('quantity') is-invalid @enderror" name="quantity" type="number" value="{{old('quantity') }}" placeholder="12345" id="example-password-input"/>
        @error('quantity')
            <span class="text-danger">{{ $message }}</span>    
        @enderror
       </div>
    ...
    <div class="form-group row">
        <label class="col-2 col-form-label">Thời gian kết thúc</label>
            <div class="col-lg-4 col-md-9 col-sm-12">
                <div class="input-group date" >
                    <input type="date" class="form-control" name="end_date" placeholder="Select time" id="kt_datetimepicker_7"/>
                    <div class="input-group-append">
                    <span class="input-group-text">
                    <i class="la la-calendar glyphicon-th"></i>
                    </span>
