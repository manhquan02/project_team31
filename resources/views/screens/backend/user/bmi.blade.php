        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">{{ ('BMI Management') }}
                        <span class="d-block text-muted pt-2 font-size-sm">{{ ('BMI') }}</span></h3>
                </div>
            ...
            <form action="{{route('admin.user.updateBMI', $bmi->user_id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-2 col-form-label">{{ ('Weight') }} ( kg )<span class="text-danger">*</span></label>
                        <div class="col-10">
                    ...
                    <div class="form-group row">
                        <label class="col-2 col-form-label">{{ ('Height') }} ( cm )<span class="text-danger">*</span></label>
                        <div class="col-10">
                    ...
                    <div class="form-group row">
                        <label class="col-2 col-form-label">{{ ('BMI') }}</label>
                        <div class="col-10">
                    ...
                    <div class="form-group row">
                        <label class="col-2 col-form-label">{{ ('Health') }}</label>
                        <div class="col-10">
