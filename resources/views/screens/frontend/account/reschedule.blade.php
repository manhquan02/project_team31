...
<div class="card-body">
    <form action="{{route('account.postReschedule', $attendanceId)}}" method="POST">
        ...
        <div class="form-group">
            ...
            <input min="2022-12-17" name="date" style="margin-bottom: 10px;" onchange="checkTimesCoach(this.value)" type="date" class="form-control" id="check-time" aria-describedby="emailHelp" placeholder="Enter email">
            @error('date')
